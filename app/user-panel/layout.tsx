        ...
        <div className="container px-3 mx-auto md:grid md:grid-cols-7 gap-3">
          ...
          {matches && (
            <aside className="col-span-2">
              <div className="bg-white border rounded-lg sticky top-12 max-h-[calc(100vh_-_170px)] grid grid-rows-[auto_auto_minmax(0,1fr)]">
                <Sidebar />
              </div>
            </aside>
          )}

          <main className="md:col-span-5 bg-gray-100 border rounded-lg p-3">
            <Suspense
              fallback={
                <BallTriangle
                  height={50}
