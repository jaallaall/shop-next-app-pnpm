...
const MainFooter: React.FC = (): React.ReactElement => {
  return (
    <footer className="text-justify text-neutral-600 bg-gray-50 mt-auto">
          ...
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="mb-4 flex">
                ...
                آدرس دفتر مرکزی: تهران، محمودیه،‌ نبش شادآور، برج ستاره
                ولنجک،‌پلاک ۱۵، طبقه ۲، واحد ۳
              </p>
              <p className="mb-4 flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
